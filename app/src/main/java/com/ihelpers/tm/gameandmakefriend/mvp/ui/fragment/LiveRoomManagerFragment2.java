...
public class LiveRoomManagerFragment2 extends BaseMainFragment {
    ...
    protected void setUpView() {
        ...
        items.add(new Item(1,""));
        items.add(new Item(1,""));
        adapter=new LiveRoomManagerFragmentAdapter(getActivity(),2,R.layout.item_live_room_manager,items);
